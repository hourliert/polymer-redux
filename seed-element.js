...
(function () {
  ...
  Polymer({
    ...
    /**
     * The `polymer-redux-lasers` event is fired whenever `fireLasers` is called.
     *
     * @event polymer-redux-lasers
     * @detail {{sound: String}}
     */
    ...
    sayHello: function sayHello(greeting) {
      ...
      return 'polymer-redux says, ' + response;
    },
    ...
    fireLasers: function fireLasers() {
      this.fire('polymer-redux-lasers', { sound: 'Pew pew!' });
    }
